...
<div id="page-wrapper" class="hidden" data-ng-controller="ModalCreateCategoryCtrl">
    <div class="innerAll">
        <div class="col-lg-12">
            <h3 class="page-header">Tạo mới danh mục</h3>
        </div>
        <div class="innerLR">
            <form method="POST" accept-charset="UTF-8" name="formCategory" ng-init="categoryItem={{$category}};categorySelected={{$categorySelected}}">
                ...
                <div class="form-group" ng-class="{true: 'has-error'}[submitted && requiredCategoryParent]" ng-if="categoriesTree.length > 0">
                    ...
                    <div class="">
                        <select-level-category items="categoriesTree" text="Danh mục" title="Chọn danh mục" ng-model="categoryItem.parent_id" selected-item="categorySelected"></select-level-category>
                    </div>
                </div>
